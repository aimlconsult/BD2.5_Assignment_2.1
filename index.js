...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  let sortingCondition = req.query.pricing;
  if (sortingCondition.toLowerCase() === 'low-to-high') {
    sortedStocks.sort(sortByPriceLowToHigh);
    res.json(sortedStocks);
  } else if (sortingCondition.toLowerCase() === 'high-to-low') {
...
app.get('/stocks/sort/growth', (req, res) => {
  let sortedStocks = stocks.slice();
  let sortingCondition = req.query.growth;
  if (sortingCondition.toLowerCase() === 'low-to-high') {
...
function filterByExchange(ele, exchange) {
  return stocks.exchange === exchange;
}
